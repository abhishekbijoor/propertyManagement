...
<body>
  ...
  <p><?php echo "please enter all the details"?></p>
</div> 
<?php endif;?>
<div class="w3-container"></div>
<div class="w3-card w3-margin w3-padding">
    <h2 class="w3-text-red">Hello <?php echo $userid;?></h2>
  <h2 class="w3-text-red">Submit Free Classified Add</h2>
  <form method="POST" action="insertplot.php" class="w3-container">
    <label class="w3-label w3-text-red">Title</label>
    <input class="w3-input w3-text-red" type="text" name="title">
